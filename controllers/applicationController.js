...
export const postApplication = catchAsyncErrors(async(req, res, next) =>{
    ...
    if(!allowedFormats.includes(resume.mimetype)){
        return next(new ErrorHandler("Invalid file format. Please upload resume in png, jpg or webp format files.", 400));
    }
    ...
    const application = await Application.create({
        name, email, coverLetter, phone, address, applicantID, employerID, resume:{public_id: cloudinaryResponse.public_id, url: cloudinaryResponse.secure_url,},
    });
